...
var RactPanelDNS = {
    ...
    init: function() {
        ...
        RactPanelDNS.cache.dnsTitleId = $("#dnsTitle");

        RactPanelDNS.events.init();
    ...
    events: {
        ...
        promptBeforeClose: function(e) {
            ...
            if (!RactPanelDNS.unsavedChanges) return;
        ...
        init: function() {
            ...
            $(document).on('change','div.hostName > input',function() {
                RactPanel.utils.log('hostname change fired');
                var hostnameSelector = $(this);
            ...
            $(document).on("keydown", "#dnsRecords input", function() {
                ...
                RactPanel.utils.log(RactPanelDNS.cache.dnsTitleId);
                RactPanel.utils.log($("#dnsTitle"));
                //$("#dnsTitle").find(".save, .undo").removeClass("disabled");
                RactPanelDNS.cache.dnsTitleId.find(".save, .undo").removeClass("disabled");
            ...
            $("#dnsRecords div.add > .btn").click(function(e) {
                RactPanel.utils.log('add record button clicked');
                RactPanelDNS.records.addRow($(this));
                e.preventDefault();
            });

            // Mark Record as "Deleted" and change the view of it's Row to reflect a Deleted item
            $(document).on("click", ".delete", function(e) {
                RactPanelDNS.records.deleteRow($(this));
                e.preventDefault();
            });
            ...
            $(document).on("keydown", "div.dnsRecord input[type='text']", function() {
                ...
                RactPanelDNS.unsavedChanges = true;
            });

            // Undo editing of an EXISTING ROW
            $("button.undo").on("click", function() {
                RactPanelDNS.records.undoRow($(this));
            });
            ...
            $("#dnsTitle a.undo").click(function() {
                ...
                RactPanelDNS.unsavedChanges = false;
                return false;
            });
    ...
    records: {
        ...
        addRow: function(record) {
            ...
            if (record.parents("div.add").siblings().length > 2) {
                RactPanel.utils.log('div .add sibblings...');
                RactPanel.utils.log(record.parents("div.add").siblings());
