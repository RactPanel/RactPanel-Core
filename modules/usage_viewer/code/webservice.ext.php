...
class webservice extends ws_xmws {
    ...
    function GetServerUsageStats() {
        ...
        $response_xml = ws_xmws::NewXMLContentSection('stats', array(
                    'ractpanelusers' => $total_accounts,
                    'activeractpanelusers' => $total_activeaccounts,
                    'disabledractpanelusers' => $total_disabledaccounts,
