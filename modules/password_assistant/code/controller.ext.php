...
class module_controller extends ctrl_module
{
    ...
    static function getResult()
    {
        if (!fs_director::CheckForEmptyValue(self::$error)) {
            ...
            if (self::$error == "error") {
                return ui_sysmessage::shout(ui_language::translate("An error occured and your RactPanel account password could not be updated. Please ensure you entered all passwords correctly and try again."), "zannounceerror");
            }
        } else {
