...
function WriteCronFile() {
    ...
    if ($numrows->fetchColumn() <> 0) {
        ...
        $line .= "#################################################################################" . fs_filehandler::NewLine();
        $line .= "# WE DO NOT RECOMMEND YOU MODIFY THIS FILE DIRECTLY, PLEASE USE RACTPANEL INSTEAD! " . fs_filehandler::NewLine();
        $line .= "#################################################################################" . fs_filehandler::NewLine();
        ...
        $line .= "# DO NOT MANUALLY REMOVE ANY OF THE CRON ENTRIES FROM THIS FILE, USE RACTPANEL     " . fs_filehandler::NewLine();
        $line .= "# INSTEAD! THE ABOVE ENTRIES ARE USED FOR RACTPANEL TASKS, DO NOT REMOVE THEM!     " . fs_filehandler::NewLine();
        $line .= "#################################################################################" . fs_filehandler::NewLine();
