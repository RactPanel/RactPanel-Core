...
class module_controller extends ctrl_module
{
    ...
    static function getCreateCron()
    {
        ...
        $line .= '<td><input name="inScript" type="text" id="inScript" size="50" /><br />'
                ...
                . ui_language::translate('Note 1 : Script path is relative to your ractpanel-user root directory:') . '<br>'
    ...
    static function WriteCronFile()
    {
        ...
        $line .= "#################################################################################" . fs_filehandler::NewLine();
        $line .= "# CRONTAB FOR RACTPANEL CRON MANAGER MODULE                                        " . fs_filehandler::NewLine();
        $line .= "# Module Developed by Bobby Allen, 17/12/2009                                    " . fs_filehandler::NewLine();
        $line .= "# File automatically generated by RactPanel " . sys_versions::ShowRactPanelVersion() . fs_filehandler::NewLine();
        $line .= "#################################################################################" . fs_filehandler::NewLine();
        $line .= "# NEVER MANUALLY REMOVE OR EDIT ANY OF THE CRON ENTRIES FROM THIS FILE,          " . fs_filehandler::NewLine();
        $line .= "#  -> USE RACTPANEL INSTEAD! (Menu -> Advanced -> Cron Manager)                    " . fs_filehandler::NewLine();
        $line .= "#################################################################################" . fs_filehandler::NewLine();
