...
{
    public static function getRactPanelUpdates()
    {   
        ...
        if ($installed < $lastest ) {
            $msg = ui_language::translate('There are currently new updates for your RactPanel installation, please download the latest release') 
                 . $lastest_tagged .' from <a href="http://www.ractpanel.ractbd.com/">http://www.ractpanel.ractbd.com/</a>.';
        } elseif ($installed == $lastest) {
            $msg = 'Congratulations, You are running the most recent version of RactPanel' . $lastest_tagged . '!';
        } else {
