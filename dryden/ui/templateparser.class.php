...
class ui_templateparser
{
    ...
    /**
     * Array of all the functions allowed by RactPanel template system with the pattern to identify them
    ...
    /**
     * Compiles RactPanel loop template tags into valid PHP
     * @author Sam Mottley (smottley@zpanelcp.com)
     */
    ...
    /**
     * Compiles RactPanel echo loop template tags into valid PHP
     * @author Sam Mottley (smottley@zpanelcp.com)
     */
    ...
    /**
     * Compiles RactPanel end loop template tags into valid PHP
     * @author Sam Mottley (smottley@zpanelcp.com)
     */
    ...
    /**
     * Compiles RactPanel if template tags into valid PHP
     * @author Sam Mottley (smottley@zpanelcp.com)
     */
    ...
    /**
     * Compiles RactPanel end if template tags into valid PHP
     * @author Sam Mottley (smottley@zpanelcp.com)
     */
    ...
    /**
     * Compiles RactPanel lanuage template tags into valid PHP
     * @author Sam Mottley (smottley@zpanelcp.com)
     */
    ...
    /**
     * Compiles RactPanel function each template tags into valid PHP
     * @author Sam Mottley (smottley@zpanelcp.com)
     */
    ...
    /**
     * Compiles RactPanel template class tag into valid PHP
     * @author Sam Mottley (smottley@zpanelcp.com)
     */
    ...
    {
        self::$storageLocation = ctrl_options::GetSystemOption('ractpanel_root') . self::$storageLocation;
    }
    ...
    /**
     * All br tags to be used using the RactPanel br tag loader
     * @author Sam Mottley (smottley@zpanelcp.com)
     */
