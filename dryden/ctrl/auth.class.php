...
class ctrl_auth
{
     ...
     * @author Bobby Allen (ballen@bobbyallen.me)
     * @param int $zpuid The RactPanel user account ID to set the session as.
     * @return bool
     */
    ...
    /**
     * Destroys a session and ends a user's RactPanel session.
     * @author Bobby Allen (ballen@bobbyallen.me)
     * @return bool
     */
     ...
     * @author Bobby Allen (ballen@bobbyallen.me)
     * @global obj $controller The RactPanel controller object.
