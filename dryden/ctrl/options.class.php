...
class ctrl_options {
     ...
     * @param string $name The name of the system option (eg. ractpanel_root)
    ...
    /**
     * An alias of 'GetSystemOption' to 'fix' the recent refactor of the ractpanel code, this was affecting third-party modules which relied on this old function name.
     * @author Bobby Allen <ballen@bobbyallen.me>
